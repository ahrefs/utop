...
val create : int -> changes event -> (unit -> Utop_zed_lines.t) -> int -> int -> t
  (** [create length changes get_lines position wanted_column] creates
      ...
      semantic as {!Utop_zed_edit.changes}.
...
val column_display : t -> int Utop_react.signal
...
val coordinates_display : t -> (int * int) Utop_react.signal
  (** [coordinates cursor] returns the signal holding the current
