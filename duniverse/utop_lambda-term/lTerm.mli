...
val fprint : t -> Utop_zed_utf8.t -> unit Lwt.t
val fprintl : t -> Utop_zed_utf8.t -> unit Lwt.t
val fprintf : t -> ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
val fprints : t -> LTerm_text.t -> unit Lwt.t
val fprintlf : t -> ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
val fprintls : t -> LTerm_text.t -> unit Lwt.t
val print : Utop_zed_utf8.t -> unit Lwt.t
val printl : Utop_zed_utf8.t -> unit Lwt.t
val printf : ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
val prints : LTerm_text.t -> unit Lwt.t
val printlf : ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
val printls : LTerm_text.t -> unit Lwt.t
val eprint : Utop_zed_utf8.t -> unit Lwt.t
val eprintl : Utop_zed_utf8.t -> unit Lwt.t
val eprintf : ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
val eprints : LTerm_text.t -> unit Lwt.t
val eprintlf : ('a, unit, Utop_zed_utf8.t, unit Lwt.t) format4 -> 'a
...
val encode_string : Utop_zed_utf8.t -> string
