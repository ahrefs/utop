...
val create : ?max_size : int -> ?max_entries : int -> Utop_zed_string.t list -> t
...
val add : t -> ?skip_empty : bool -> ?skip_dup : bool -> Utop_zed_string.t -> unit
...
val contents : t -> Utop_zed_string.t list
...
val entry_size : Utop_zed_string.t -> int
